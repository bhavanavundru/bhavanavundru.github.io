...
<p class="hero-subtitle animate-fade">Everything in it's right place.</p>
        ...
        <div class="intro-image">
            <img src="/Bhavcodes/images/image1.jpeg" alt="Portfolio Image" class="hero-image">
        </div>
    </div>
</section>
...
<section id="about" class="section animate-on-scroll">
    ...
    <div class="contact-info">
        <h3>Availability</h3>
        <p>I'm taking on freelance projects on a case-by-case basis. Reach out and touch faith.</p>
        <h3>Contact</h3>
        <p>Email: <a href="mailto:yo@example.com">yo@example.com</a></p>
    </div>
</section>
